                            ...
                            <div key={q.id} className=" w-full flex-shrink-0 px-2 sm:px-4"
                                ...
                                {(q.input === 'date' || q.input === 'email' || q.input === 'password' || q.input === 'text') ? (
                                        ...
                                        <span key={idx} className={currentStep === 4 ? 'flex justify-center' : ''}>
                                            <button
                                                className={`text-[#AE2456] border m-2 py-2 px-6 rounded-3xl w-full sm:w-auto 
                                                    ${answers[q.apiname] === option ? 'bg-[#AE2456] text-white' : ''}
                                                `}
                                                onClick={() => {
                                                    setAnswers({ ...answers, [q.apiname]: option });
                                                    setTimeout(() => {
                                                        handleNext();
                                                    }, 1000);
                                                }}
                                    ...
                                    q.options?.map((option) => (
                                        <span key={option.id} className={currentStep === 4 ? 'flex justify-center' : ''}>
                                            <button
                                                className={`text-[#AE2456] border m-2 py-2 px-6 rounded-3xl w-full sm:w-auto 
                                                    ${answers[q.apiname] === option.id ? 'bg-[#AE2456] text-white' : ''}
                                                `}
                                                onClick={() => {
                                                ...
                                                q.options?.map((option) => (
                                                    ...
                                                    >
                                                        <div className='flex items-center gap-1'>
                                                            <img src={option.image} alt="" className='w-3 h-3 mr-2' />
                            ...
                            {questions.map((_, index) => (
                                <div
                                    ...
                                    className={`h-2 w-2 rounded-full ${
                                        index <= currentStep ? 'bg-[#AE2456]' : 'bg-gray-300'
                                    }`}
                                />
                            ))}
                        </div>
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row justify-between gap-3 sm:gap-0">
                        ...
                        {currentStep === 3 ? (
                            <button
                                ...
                                className="bg-green-600 text-white py-2 px-6 rounded-3xl w-full sm:w-auto hover:bg-green-700 transition-colors"
                            >
                                That's it 
                            </button>
                        ) : (
